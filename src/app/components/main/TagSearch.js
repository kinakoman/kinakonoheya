...
export default function TafSearch({ TagList, TagNow, setTagNow }) {
    ...
    return (
        <>
            <div className={styles.searchTag} style={{ height: searchBoxOn === "ON" ? `500px` : "50px", width: searchBoxOn === "ON" ? "90vw" : "100px", border: "solid 2px #84C98B", backgroundColor: "white", position: "absolute", right: "5%", top: "20px", zIndex: "999", borderRadius: "5px", transition: searchBoxOn === "SELECT" ? "0s" : "all 0.3s", overflow: "hidden" }}>

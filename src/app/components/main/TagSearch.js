...
export default function TafSearch({ TagList, TagNow, setTagNow, setPageNow, pageNum, pageNow }) {
    ...
    return (
        <>
            <div className={styles.searchTag} style={{ height: searchBoxOn === "ON" ? `500px` : "50px", width: searchBoxOn === "ON" ? "90vw" : "100px", border: "solid 2px #76D9FF", backgroundColor: "white", position: "absolute", right: "5%", top: "calc(50% - 25px)", zIndex: "999", borderRadius: "5px", transition: searchBoxOn === "SELECT" ? "0s" : "all 0.2s ease-in-out", overflow: "hidden" }}>
                ...
                <div style={{ alignContent: "space-evenly", display: "flex", padding: "20px 100px", width: "90vw", height: "450px", flexWrap: "wrap", gap: "20px", position: "absolute", right: "0", top: "50px", overflowY: searchBoxOn === "ON" ? `scroll` : "hidden" }}>
                    {TagButton}
                </div>
            </div >
        </>

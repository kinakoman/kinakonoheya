...
const CodeBox = ({ lang, comment, children }) => {
    return (
        <div className={styles.codeBox}>
            ...
            <SyntaxHighlighter language={lang} style={lang === "shell" ? hybrid : anOldHope} customStyle={{ fontSize: "16px", padding: "10px", borderRadius: "0 0 5px 5px", overflowX: "auto", paddingRight: "40px" }}>
                {children}
            </SyntaxHighlighter>
        </div>
    );

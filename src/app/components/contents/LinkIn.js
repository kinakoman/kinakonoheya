...
export default function LinkIn({ link, title }) {
    return (
        <div style={{ height: "60px", width: "100%", border: "solid 2px", borderColor: "rgba(0,0,0,0.5)", borderRadius: "10px", marginTop: "15px", position: "relative", display: "flex", padding: "0 20px", overflow: "hidden", }}>
